...
public class ParameterBufferBuilder
    ...
    public <B extends DataProcessor> ParameterBuffer setup (Class<B> dataClass, ClContext context) {
    ...
    public <B extends DataProcessor> ParameterBuffer setup (String bufferName, Class<B> dataClass, ClContext context) {
        withName(bufferName);
