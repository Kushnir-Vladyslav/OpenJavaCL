...
public interface ReadableImage <T extends CopyableImageBuffer & ReadableImage<T>> {
    ...
    @SuppressWarnings("unchecked")
    default Object readSync(CopyableImageBuffer.ImageRegion region, int rowPitch, int slicePitch, ClEventList events) {
        T buffer = (T) this;
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            Object targetArray = ((FromByteBuffer)buffer.dataProcessor).createArr((int)dataLength);
    ...
    @SuppressWarnings("unchecked")
    default ClEvent readAsyncByte(CopyableImageBuffer.ImageRegion region, int rowPitch, int slicePitch, ClEventList events, byte[] targetArray) {
        T buffer = (T) this;
    ...
    @SuppressWarnings("unchecked")
    default void readSyncByte(CopyableImageBuffer.ImageRegion region, int rowPitch, int slicePitch, ClEventList events, byte[] targetArray) {
        T buffer = (T) this;
    ...
    @SuppressWarnings("unchecked")
    default byte[] readSyncByte(CopyableImageBuffer.ImageRegion region, int rowPitch, int slicePitch, ClEventList events) {
        T buffer = (T) this;
